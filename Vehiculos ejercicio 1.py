...
class Camion(Camioneta):
    
    def __init__(self, color, ruedas, velocidad, cilindrada, carga, ejes):
        super().__init__(color, ruedas, velocidad, cilindrada, carga)
        self.ejes = ejes
        
    def __str__(self):
        return super().__str__() + ", {} ejes".format(self.ejes)
...
lista = [
    ...
    Camion("rojo", 10, 100, 15000, 20000, 3),
